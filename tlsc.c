...
gcc -o ssl_server -Iinclude programs/ssl/ssl_server.c -Llibrary -lmbedx509 -lmbedcrypto -lmbedtls
gcc -o ssl_client -Iinclude programs/ssl/ssl_client1.c -Llibrary -lmbedtls -lmbedx509 -lmbedcrypto

release
gcc -o cli -Iinclude tlsc.c -Llibrary -lmbedtls -lmbedx509 -lmbedcrypto

debug
gcc -g -o cli -Iinclude tlsc.c -Llibrary -lmbedtls -lmbedx509 -lmbedcrypto
...
#define DFL_SERVER_NAME         "httpbin.org"
#define DFL_SERVER_ADDR         NULL
#define DFL_SERVER_PORT         "443"
#define DFL_REQUEST_PAGE        "/user-agent"
#define DFL_REQUEST_SIZE        -1
#define DFL_DEBUG_LEVEL         0
#define DFL_NBIO                0
#define DFL_READ_TIMEOUT        0
#define DFL_MAX_RESEND          0
#define DFL_CA_FILE             "/home/daeyeon/Code/daeyeon.mbedtls/trusted-ca-list.crt"
#define DFL_CA_PATH             ""
#define DFL_CRT_FILE            ""
#define DFL_KEY_FILE            ""
#define DFL_PSK                 ""
